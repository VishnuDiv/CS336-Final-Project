...
<%
	...
	if (rs.next()) {
		out.println("Admin ID exists, please try another <a href='addAdmin.jsp'>try again</a>");
	} else {
		int x = stmt.executeUpdate("insert into Department (depname, depadmin, adminname) values('" +department+ "', '" +userid+"', '" +name+"')");
